               ...
               <div class="col-md-6 col-lg-4 mt-5 wow fadeInUp" data-wow-delay=".2s"
                   ...
                   <div class="blog-grid">
                       <div class="blog-grid-img position-relative">
                           @if ($blog->image_url)
                               <img alt="img" src="{{ asset('storage/' . $blog->image_url) }}">
                           @else
                       ...
                       <div class="blog-grid-text p-4">
                           <h3 class="h5 mb-3">
                            <a href={{ route('web-blog-show', $blog->id) }}>{{ $blog->name }}</a>
                           </h3>
                           <p class="display-30">{{ $blog->short_description ?? $blog->description }}</p>
                           <div class="meta meta-style2">
                               <ul>
                                   <li>
                                       <a href="#!">
                                           <i class="fas fa-calendar-alt"></i>
                                           {{ $blog->date ? date('d M, Y', strtotime($blog->date)) : '' }}
                                       </a>
                                   </li>
       ...
       <div class="row mt-6 wow fadeInUp" data-wow-delay=".6s"
           ...
           <div class="col-12">
               <div class="pagination text-small text-uppercase text-extra-dark-gray">
                   {{ $blogs->links('website.pagination') }}
                   {{-- <ul>
                       <li><a href="#!">Prev</a></li>
