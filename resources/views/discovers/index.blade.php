        ...
        <div class="modal fade" id="verticallyCentered" tabindex="-1" aria-labelledby="verticallyCenteredModalLabel"
            ...
            <div class="modal-dialog modal-dialog-centered modal-lg">
                <div class="modal-content">
                    ...
                    <form action={{ route('discover-slider-upload') }} method="post" enctype="multipart/form-data"
                        name="Slider_form">
                        @csrf
        ...
        <div class="modal fade" id="verticallyCentered-1" tabindex="-1"
            ...
            <div class="modal-dialog modal-dialog-centered modal-lg">
                <div class="modal-content">
                    ...
                    <form action={{ route('discovers.store') }} method="post" enctype="multipart/form-data"
