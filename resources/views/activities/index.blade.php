        ...
        <div class="modal fade" id="verticallyCentered" tabindex="-1" aria-labelledby="verticallyCenteredModalLabel"
            ...
            <div class="modal-dialog modal-dialog-centered modal-lg">
                <div class="modal-content">
                    ...
                    <form action={{ route('activity_slider_upload') }} method="post" enctype="multipart/form-data" name="Slider_form">
                        @csrf
        ...
        <div class="modal fade" id="verticallyCentered-1" tabindex="-1"
            ...
            <div class="modal-dialog modal-dialog-centered modal-lg">
                <div class="modal-content">
                    ...
                    <form action={{ route('activities.store') }} method="post" enctype="multipart/form-data" name="main_form_create">
                        @csrf
                        <div class="modal-body">
                            <div class="mb-3">
        ...
        <div class="modal fade" id="verticallyCentered-2" tabindex="-1"
            ...
            <div class="modal-dialog modal-dialog-centered modal-lg">
                <div class="modal-content">
                    ...
                    <form action={{ route('activities.store') }} method="post" enctype="multipart/form-data" name="main_form_edit">
                        @csrf
